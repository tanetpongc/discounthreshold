---
title: "Testing the discount significance and nonlinearity of price and discount"
author: "Tanetpong"
date: "23/11/2021"
output: pdf_document
...
```{r category of interest, include=FALSE}
categoryinuselist= c("Baking ingredients","Biscuits","Bottled water","Butter","Canned vegetables","Cereals","Chips & Salty snacks", "Chocolate","Cleaning products","Coffee","Cookies","Cream","Dishwasher & washing up","Frozen Pizza Snacks","Fruit Juice","Ice cream","Jam","LactoseFree","Laundry","Pasta","Pastry","Ready-made meals","Rice","Seasoning","Soft drinks","Sweets & Candy","Toilet tissue","Toiletries","Yogurt")
```


# Write necessary function

```{r function of subsetting data,include=FALSE}
