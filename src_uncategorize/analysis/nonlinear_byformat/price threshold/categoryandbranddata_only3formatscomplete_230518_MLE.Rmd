...
lm_linear <- lm(dlogtotalvolume ~ dlogavgfinalprice + I(dlogavgfinalprice^2)+ I(dlogavgfinalprice^3) + dlogavgcompfinalprice + dlogavgfinalprice*dlogavgcompfinalprice + dlogavgfinalprice*I(dlogavgcompfinalprice^2) + nonpricecampaign + pricecampaign + et_hat+ holiday + cop_logfinalprice + cop_logavgcompfinalprice ,data=brand_data)
...
logL_nonlinearfull <- function(parvec){
  ...
  ut <- brand_data$dlogtotalvolume - (parvec[1] + (parvec[2] 
                            ...
                            + parvec[11]*brand_data$nonpricecampaign + parvec[12]*brand_data$pricecampaign
                            + parvec[13]*brand_data$et_hat +  parvec[14]*brand_data$holiday
                            + parvec[15]*brand_data$cop_logfinalprice +  parvec[16]*brand_data$cop_logavgcompfinalprice)
  logL <- sum (-0.5* log(parvec[17]) - 0.5*ut^2/parvec[17] )
  return(-logL)
  }
...
#                   7:cgap_gain_slope,8:cgap_gain_threshold,9:cgap_loss_slope,10:cgap_loss_threshold)
  ...
  parvec_16 <- summary(lm_linear)$coefficients[12,1]
  parvec_17 <- 1.0 #standard se
  Start_v <- c(parvec_1,parvec_2,parvec_3,parvec_4,parvec_5,parvec_6,parvec_7,parvec_8,
               parvec_9,parvec_10,parvec_11,parvec_12,parvec_13,parvec_14,parvec_15,parvec_16,parvec_17)
...
par_name <- c("constant", "price_elas" ,"hgap_gain_slope","hgap_gain_threshold","hgap_loss_slope","hgap_loss_threshold",
          ...
          "nonpricecampaign","pricecampaign","ethat","holiday","cop_price","cop_compprice","model_SE")
...
lm_linear <- lm(dlogtotalvolume ~ dlogavgfinalprice + I(dlogavgfinalprice^2)+ I(dlogavgfinalprice^3) + dlogavgcompfinalprice  + nonpricecampaign + pricecampaign + et_hat+ holiday + cop_logfinalprice + cop_logavgcompfinalprice ,data=brand_data)
...
logL_nonlinearfull <- function(parvec){
  ...
  ut <- brand_data$dlogtotalvolume - (parvec[1] + (parvec[2] 
                            ...
                            + parvec[8]*brand_data$nonpricecampaign + parvec[9]*brand_data$pricecampaign
                            + parvec[10]*brand_data$et_hat +  parvec[11]*brand_data$holiday
                            + parvec[12]*brand_data$cop_logfinalprice +parvec[13]*brand_data$cop_logavgcompfinalprice)
  logL <- sum (-0.5* log(parvec[14]) - 0.5*ut^2/parvec[14] )
  return(-logL)
  }
#starting value = c(1:constant, 2:price_elas ,3:hgap_gain_slope,4:hgap_gain_threshold,5:hgap_loss_slope,6:hgap_loss_threshold
#                   7:cgap_gain_slope,8:cgap_gain_threshold,9:cgap_loss_slope,10:cgap_loss_threshold)
  ...
  parvec_13 <- summary(lm_linear)$coefficients[11,1]
  parvec_14 <- 1.0 #standard se
  Start_v <- c(parvec_1,parvec_2,parvec_3,parvec_4,parvec_5,parvec_6,parvec_7,parvec_8,
               parvec_9,parvec_10,parvec_11,parvec_12,parvec_13,parvec_14)
...
lm_linear <- lm(dlogtotalvolume ~ dlogavgfinalprice + dlogavgfinalprice*dlogavgcompfinalprice + dlogavgfinalprice*I(dlogavgcompfinalprice^2) + dlogavgcompfinalprice  + nonpricecampaign + pricecampaign + et_hat + holiday + cop_logfinalprice + cop_logavgcompfinalprice ,data=brand_data)
...
lm_linear <- lm(dlogtotalvolume ~ dlogavgfinalprice + dlogavgcompfinalprice + nonpricecampaign + pricecampaign + et_hat + holiday + cop_logfinalprice + cop_logavgcompfinalprice ,data=brand_data)
  ...
  parvec_9 <- summary(lm_linear)$coefficients[9,1]
  par.est <- c(parvec_1,parvec_2,parvec_3,parvec_4,parvec_5,parvec_6,parvec_7,parvec_8,parvec_9)
  ...
  se_9 <- summary(lm_linear)$coefficients[9,2]
  par.se <- c(se_1,se_2,se_3,se_4,se_5,se_6,se_7,se_8,se_9)
...
# est_butter_ICA_convenience = est_compgap(df,format = "convenience",category ="Butter",nweek=153,brand = "ICA",gamma = 100) #require investigation, Multiple parvec is zero for hessian

#Milda
est_butter_Milda_hypermarket = est_linear(df,format = "hypermarket",category ="Butter",nweek=153,brand = "Milda",gamma = 100)
# est_butter_Milda_super = est_compgap(df,format = "supermarket",category ="Butter",nweek=153,brand = "Milda",gamma = 100) #require investigation, Multiple parvec is zero for hessian
est_butter_Milda_convenience = est_fullnonlinear(df,format = "convenience",category ="Butter",nweek=153,brand = "Milda",gamma = 100)

#KronjÃ¤st
est_butter_Kronjast_hypermarket = est_histgap(df,format = "hypermarket",category ="Butter",nweek=153,brand = "KronjÃ¤st",gamma = 100) #they have no nonprice campaign
est_butter_kronjast_super = est_linear(df,format = "supermarket",category ="Butter",nweek=153,brand = "KronjÃ¤st",gamma = 100)
est_butter_kronjast_convenience = est_histgap(df,format = "convenience",category ="Butter",nweek=153,brand = "KronjÃ¤st",gamma = 100)
