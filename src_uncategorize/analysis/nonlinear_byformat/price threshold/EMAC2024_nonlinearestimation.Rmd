...
```{r esimation function and plotting}
discountnonlinearest_PL_nothreshold <- function(df,alpha_l_price,alpha_l_discount){
...
print(paste("Linearmodel_price_coef:",summary(lm_full_linear)$coefficients[2,1],"Linearmodel_price_se:",summary(lm_full_linear)$coefficients[2,2],"Linearmodel_disc_coef:",summary(lm_full_linear)$coefficients[3,1],"Linearmodel_disc_se:",summary(lm_full_linear)$coefficients[3,2]))

  parvec_1 <- c_full_lm
  parvec_2 <- alpha_0_full_lm
  parvec_3 <- alpha_l_price
  parvec_4 <-  alpha_0_disc_lm
  parvec_5 <- alpha_l_discount
  parvec_6 <- alpha_compprice
  parvec_7 <- phi_1_full_lm
  parvec_8 <- phi_2_full_lm
  parvec_9 <- phi_3_full_lm
