...
#biscuit_conve_PL <- genrelevantvar_perSKU(df,format = "convenience",category ="Biscuits") 
...
#bottledwater_conve_PL <- genrelevantvar_perSKU(df,format = "convenience",category ="Bottled water") 
...
#cereals_conve_PL <- genrelevantvar_perSKU(df,format = "convenience",category ="Cereals") 
...
#coffee_conve_PL <- genrelevantvar_perSKU(df,format = "convenience",category ="Coffee") 
...
```{r plot explore}
Combined_Dataset <- rbind(baking_hyper_PL, 
                          biscuit_hyper_PL,
                          butter_hyper_PL,butter_super_PL,
                          cereals_hyper_PL,cereals_super_PL,
                          chips_hyper_PL,
                          cream_hyper_PL,cream_super_PL,
                          juice_hyper_PL,
                          jam_hyper_PL,
                          lactosefree_hyper_PL,lactosefree_super_PL,
                          readymeal_hyper_PL,
                          rice_hyper_PL,
                          yoghurt_hyper_PL)

Combined_Dataset_PL_est_plot <- rbind( 
                          biscuit_hyper_PL_est_plot,
                          butter_hyper_PL_est_plot,butter_super_PL_est_plot,
                          cereals_hyper_PL_est_plot,cereals_super_PL_est_plot,
                          chips_hyper_PL_est_plot,
                          cream_hyper_PL_est_plot,cream_super_PL_est_plot,
                          juice_hyper_PL_est_plot,
                          jam_hyper_PL_est_plot,
                          lactosefree_hyper_PL_est_plot,lactosefree_super_PL_est_plot,
                          readymeal_hyper_PL_est_plot,
                          yoghurt_hyper_PL_est_plot)
...
Combined_Dataset_PL_est_plot <- rbind( 
                          ...
                          cream_hyper_PL_est_plot,cream_super_PL_est_plot,
                          lactosefree_hyper_PL_est_plot,lactosefree_super_PL_est_plot)
Combined_Dataset_PL_est_plot$dlogprice_values <- as.numeric(Combined_Dataset_PL_est_plot$dlogprice_values)
Combined_Dataset_PL_est_plot$NLPE_values_finalprice <- as.numeric(Combined_Dataset_PL_est_plot$NLPE_values_finalprice)
Combined_Dataset_PL_est_plot$category <- as.factor(Combined_Dataset_PL_est_plot$category)
Combined_Dataset_PL_est_plot$format <- as.factor(Combined_Dataset_PL_est_plot$format)

ggplot(Combined_Dataset_PL_est_plot, aes(x = dlogprice_values, y = NLPE_values_finalprice, color = category, linetype = format)) +
  geom_line() +
...
Combined_result_discount_plot <- rbind(
                          biscuit_hyper_PL_est_discount_plot,
                          ...
                          chips_hyper_PL_est_discount_plot,
                          cream_hyper_PL_est_discount_plot,cream_super_PL_est_discount_plot,
                          juice_hyper_PL_est_discount_plot,
                          jam_hyper_PL_est_discount_plot,
                          lactosefree_hyper_PL_est_discount_plot,lactosefree_super_PL_est_discount_plot,
                          readymeal_hyper_PL_est_discount_plot,
                          yoghurt_hyper_PL_est_discount_plot)
