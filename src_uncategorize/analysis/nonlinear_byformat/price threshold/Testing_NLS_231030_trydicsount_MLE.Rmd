...
LS_nonlinear_full <- function(parvec){
  ...
  ut <- df_full$dlogtotalvolume - (parvec[1] + (parvec[2] + parvec[3]*F_H_G + parvec[5]*F_H_L)*df_full$dlogavgpricebefore 
  ...
  logL <- sum (-0.5* log(parvec_14) - 0.5*ut^2/parvec_14)
  return(-logL)
}
...
LS_nonlinear_full <- function(dlogavgpricebefore,dlognondepth,totalvolume1,avgfinalprice1,parvec_1,parvec_2,parvec_3,parvec_4,parvec_5,parvec_6,parvec_7,parvec_8,parvec_9,parvec_10,parvec_11,parvec_12,parvec_13){
  F_H_G <- 1/(1+exp(500*(dlogavgpricebefore - parvec[4])))
  F_H_L <- 1/(1+exp(-500*(dlogavgpricebefore - parvec[6])))
  
  F_D_G <- 1/(1+exp(500*(dlognondepth - parvec[9])))
  F_D_L <- 1/(1+exp(-500*(dlognondepth - parvec[11])))
  
  parvec[1] + (parvec[2] + parvec[3]*F_H_G + parvec[5]*F_H_L)*dlogavgpricebefore 
...
m.sinexp <- nls(dlogtotalvolume ~ LS_nonlinear_full(dlogavgpricebefore,dlognondepth,totalvolume1,avgfinalprice1,parvec_1,parvec_2,parvec_3,parvec_4,parvec_5,parvec_6,parvec_7,parvec_8,parvec_9,parvec_10,parvec_11,parvec_12,parvec_13),data = df_full, start = list(parvec_1=c_full_lm, parvec_2 =alpha_0_full_lm, parvec_3=alpha_g_his_full_lm, parvec_4 = beta_l_his_full_lm, parvec_5 = alpha_l_his_full_lm,  parvec_6 = beta_g_disc_full_lm,
  parvec_7 =  alpha_0_disc_lm,
  parvec_8 = alpha_g_disc_full_lm,
  parvec_9 = beta_g_disc_full_lm, 
  parvec_10 = alpha_l_disc_full_lm, 
