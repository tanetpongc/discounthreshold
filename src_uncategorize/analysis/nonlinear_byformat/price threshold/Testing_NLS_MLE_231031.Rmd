...
stage0_LS_nonlinear_full <- function(parvec){
  ...
  F_H_G <- 1/(1+exp(gamma*(df_full$cgap - parvec[4])))
  F_H_L <- 1/(1+exp(-gamma*(df_full$cgap - parvec[6])))
  
  
  ut <- df_full$dlogtotalvolume - (parvec[1] + (parvec[2] 
                                         + parvec[3]*F_H_G + parvec[5]*F_H_L)*df_full$clogavgfinalprice 
...
stage0_Start_v_LS <- c(parvec_1,parvec_2,parvec_3,parvec_4,parvec_5,parvec_6,parvec_7,parvec_8,parvec_9)
